...
export default function ArticleContent({ article }: ArticleContentProps) {
  ...
  return (
    <div className="relative min-h-screen pb-24">
      ...
      <div className="relative z-10 flex justify-center px-4 pt-28 sm:px-6 lg:px-8">
        <article className="w-full max-w-5xl overflow-hidden rounded-3xl border border-white/15 bg-white/10 text-white shadow-2xl backdrop-blur-lg">
          <div className="relative h-[22rem] sm:h-[26rem]">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-black/35 to-black/60" aria-hidden />
          </div>
