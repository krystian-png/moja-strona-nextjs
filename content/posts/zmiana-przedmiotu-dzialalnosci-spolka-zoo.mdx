...
<h1>Zmiana przedmiotu działalności w spółce z ograniczoną odpowiedzialnością</h1>

<h3>Podstawa prawna</h3>

<p>Zmiana przedmiotu działalności spółki z ograniczoną odpowiedzialnością (sp. z o.o.) jest uregulowana przede wszystkim w Kodeksie spółek handlowych (KSH), w szczególności w art. 157 § 1 oraz art. 255 KSH. Umowa spółki z ograniczoną odpowiedzialnością powinna określać m.in. przedmiot działalności spółki. Zmiana tego przedmiotu wymaga zmiany umowy spółki, a zgodnie z art. 255 § 1 KSH – uchwały wspólników oraz wpisu zmiany umowy do rejestru.</p>
...
<p>Należy podkreślić, że zmiana przedmiotu działalności spółki z o.o. to zmiana istotna, wymagająca zachowania wszystkich obowiązujących procedur w tym zakresie (w tym zachowania wymaganej większości głosów – co do zasady większości dwóch trzecich głosów, a w przypadku istotnej zmiany przedmiotu działalności większości trzech czwartych głosów, o ile umowa spółki nie przewiduje surowszych warunków – odpowiedniej formy – z wyjątkiem zmiany przez system S24 i zgłoszenia do KRS). Zmiana przedmiotu działalności niesie daleko idące konsekwencje zarówno dla spółki, jak i jej wspólników, stąd regulacja stawia szereg wymagań, które służą ochronie interesu wspólników i transparentności obrotu gospodarczego.</p>
...
<li><strong>Ryzyko błędów proceduralnych</strong> – nieprawidłowości w procedurze mogą skutkować odrzuceniem wniosku o wpis do KRS, w związku z czym konieczne jest zachowanie wszystkich wymagań wynikających z przepisów.</li>
...
<p>Należy pamiętać o zmianach regulacyjnych w zakresie kodów PKD odnoszących się do przedmiotu działalności i podlegających ujawnieniu w KRS. Zgodnie z § 2 ust. 3 rozporządzenia Rady Ministrów z dnia 18 grudnia 2024 r. w sprawie Polskiej Klasyfikacji Działalności (PKD), podmioty wpisane do Krajowego Rejestru Sądowego lub krajowego rejestru urzędowego podmiotów gospodarki narodowej, które po dniu wejścia w życie tego rozporządzenia, a przed upływem terminu określonego w ust. 2, składają wnioski o wpis zmian do rejestru w zakresie przedmiotu działalności, są obowiązane do stosowania nowych kodów PKD.</p>

<p>Zmieniając przedmiot działalności po nowelizacji PKD, należy odpowiednio zaktualizować ich brzmienie oraz zakres ujawniony w rejestrze.</p>
